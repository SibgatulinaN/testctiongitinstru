...
6. Проводим изменения на Github и выкачиваем актуальное состояние из удаленного репозитория
 ...
 Чтобы взять актуальную версию с Github и перенести к нам на локальный компьютер в наш репозиторий, необходимо набрать команду `git pull` При этой команде программа не только перенесет всю информацию к нам , а и сольет (c merg ит) состояние которое было на giyhub c нашим локалным состоянием.
